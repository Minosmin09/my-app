        ...
        <div>
            <ul>
                {todos.map((todo, index) => (
                    <li key={todo.id} className="flex items-center gap-4 border-b-2 border-gray-300 p-2 cursor-pointer" >
                        <span>{index + 1}. </span>
            ...
            <button
                onClick={addTask}
                className="border-2 border-gray-300 rounded-lg p-2 m-2 bg-blue-500 text-white hover:bg-blue-600 cursor-pointer"
            >Add</button>
        </div>
    </div>)
}